                ...
                {activeCategory.children.map((sub: any) => (
                  <div key={sub.id} className="space-y-3">
                    ...
                    <Link
                      ...
                      className="block text-[14px] font-bold tracking-tight uppercase hover:text-orange-600"
                    >
                      {sub.name}
                    </Link>
                        ...
                        {sub.children.map((child: any) => (
                          <li key={child.id}>
                            <Link
                              ...
                              className="block text-[13px] text-gray-500 transition-colors hover:text-orange-500 dark:text-white"
                            >
                              {child.name}
                            </Link>
                          </li>
